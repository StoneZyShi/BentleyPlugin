...
/*    { 1, CT_NONE,       INHERIT,        DEF,            "CREATE",         CMDNAME_PolyfaceCreateTool },
	...
	{ 3, CT_NONE,       INHERIT,        DEF,            "NEWTEST",            CMDNAME_newTest },
	{ 4, CT_NONE,       INHERIT,        DEF,            "SERVERCREATDATA",            CMDNAME_ServerCreatData },
	{ 5, CT_NONE,       INHERIT,        DEF,            "CLIENTCREATDATA",            CMDNAME_ClientCreatData },*/
    { 1, CT_NONE,       INHERIT,        DEF,            "SERVERCREATDATA",         CMDNAME_ServerCreatData },
	{ 2, CT_NONE,       INHERIT,        DEF,            "CLIENTCREATDATA",        CMDNAME_ClientCreatData },
    };
