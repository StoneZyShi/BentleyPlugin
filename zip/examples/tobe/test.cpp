...
#ifdef UNICODE
	_stprintf_s(zipT, MAX_PATH, _T("%S"), strZip.c_str());//%S宽字符
	_stprintf_s(desT, MAX_PATH, _T("%S"), des.c_str());//%S宽字符
	_stprintf_s(srcT, MAX_PATH, _T("%S"), src.c_str());//%S宽字符
#else
	_stprintf_s(zipT, MAX_PATH, _T("%s"), strZip.c_str());//%s单字符
	_stprintf_s(desT, MAX_PATH, _T("%s"), des.c_str());//%s单字符
	_stprintf_s(srcT, MAX_PATH, _T("%s"), src.c_str());//%s单字符
#endif
